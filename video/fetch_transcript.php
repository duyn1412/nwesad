...
// Skip OAuth2 - Use AI transcription only
// OAuth2 authentication disabled for AI transcription
...
// Skip YouTube API calls - Use AI transcription only
// OAuth2 and YouTube API calls disabled

$videoTitle = "YouTube Video - " . $videoId; // Default title
$availableCaptions = []; // Empty captions array
