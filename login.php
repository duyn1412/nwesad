...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   // $stmt = $conn->prepare("SELECT * FROM nwengine_user    WHERE username = ?");

    $stmt = $conn->prepare("SELECT username, password FROM nwengine_user WHERE username = ?");
    ...
    // Bind the result
    $result = $stmt->bind_result($db_username, $db_password);
    if ($result === false) {
...
<script type="application/ld+json">
  {
    ...
    },
    {
        ...
        "url":"https://www.nwengineeringllc.com",
        "inLanguage":"en-US",
        "name":"NWES Admin | Northwest Engineering Solutions",
        ...
        "description":"Northwest Engineering Solutions NWES Admin",
        ...
        "itemListElement":[{
            ...
            },
          {
              "@type":"ListItem",
              "position":2,
              "item":{"@type":"WebPage","@id":"https://www.nwengineeringllc.com/pcb-material-search","url":"https://www.nwengineeringllc.com/pcb-material-search","name":"NWES Admin"}
          }]
        }
    ]
  }
  ...
  <div id="webpage" class="site-wrap">
    ...
    <div class="site-navbar-wrap bg-white">
     ...
     <div class="site-section">
      <div class="container">
      <h2 style="text-align: center; margin-top:25px;">Login</h2>
